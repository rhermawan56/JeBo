                    ...
                    <div class="col" style="display:">
                        <div class="p-3">
                            <input name="product_id" type="number" class="form-control" id="hidden"
                                @if ($transaction != null) value="{{ $transaction->product->id }}" @endif readonly>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="p-3">
                            ...
                            <input name="order_by" type="text"
                                ...
                                @if ($transaction != null) value="{{ old('order_by', $transaction->order_by) }}" @else value="{{ old('order_by') }}" @endif>
                            @error('order_by')
                        ...
                        <div class="p-3">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control @error('product_id') is-invalid @enderror"
                                    id="product"
                                    @if ($transaction != null) value="{{ $transaction->product->product }}" @endif>
                    ...
                    <div class="col">
                        <div class="p-3">
                            ...
                            <input name="qty" type="number" class="form-control @error('qty') is-invalid @enderror"
                                id="Qty" @if ($transaction != null) value="{{ $transaction->qty }}" @endif>
                            @error('qty')
                                <div class="invalid-feedback d-block">
                                    {{ $message }}
                                </div>
